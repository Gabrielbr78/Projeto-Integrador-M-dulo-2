...
--
-- Host: 127.0.0.1
-- Generation Time: 27-Set-2019 às 01:34
...
(1, 'Gabriel Brandão Rodriguez', 'gabrielbr_21@outlook.com', 'Desenvolvimento Web');
...
INSERT INTO `pedidos` (`cod_pedido`, `tipo_pessoa`, `nome`, `cpf_cnpj`, `telefone`, `nome_contato`, `email`, `servico`, `descricao`) VALUES
(1, 'Pessoa Física', 'Gabriel Brandão Rodriguez', '15126922718', '(21)97026-8550', 'Gabriel', 'gabrielbr_21@outlook.com', 'Desenvolvimento de Software', 'uohwdofdwjpsdfiohgwoeifhgoiewhfvodfjfioerhopwiefbnfolkrgemfsgesgbdg'),
(2, 'Pessoa Jurídica', 'Empresa do João Batata', '53475454552415874', '(21)86456-7468', 'João Batata', 'joao_batata@gmail.com', 'Desenvolvimento Web', 'Desenvolver um site com várias pirocas giratórias coloridas e pulsantes.');
...
--
ALTER TABLE `curriculos`
  MODIFY `cod_curriculo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
